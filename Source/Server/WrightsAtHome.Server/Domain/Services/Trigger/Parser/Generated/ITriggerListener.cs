...
namespace WrightsAtHome.Server.Domain.Services.Trigger.Parser.Generated
{
    ...
    public interface ITriggerListener : IParseTreeListener
    {
        ...
        /// <summary>
        /// Enter a parse tree produced by the <c>TimeConst</c>
        /// labeled alternative in <see cref="TriggerParser.expr"/>.
        /// </summary>
        /// <param name="context">The parse tree.</param>
        void EnterTimeConst([NotNull] TriggerParser.TimeConstContext context);
        /// <summary>
        /// Exit a parse tree produced by the <c>TimeConst</c>
        /// labeled alternative in <see cref="TriggerParser.expr"/>.
        /// </summary>
        /// <param name="context">The parse tree.</param>
        void ExitTimeConst([NotNull] TriggerParser.TimeConstContext context);
        ...
        /// <summary>
        /// Enter a parse tree produced by the <c>CurrentTime</c>
        /// labeled alternative in <see cref="TriggerParser.expr"/>.
        /// </summary>
        /// <param name="context">The parse tree.</param>
        void EnterCurrentTime([NotNull] TriggerParser.CurrentTimeContext context);
        /// <summary>
        /// Exit a parse tree produced by the <c>CurrentTime</c>
        /// labeled alternative in <see cref="TriggerParser.expr"/>.
        /// </summary>
        /// <param name="context">The parse tree.</param>
        void ExitCurrentTime([NotNull] TriggerParser.CurrentTimeContext context);
